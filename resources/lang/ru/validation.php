...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'name' => [
            ...
            'max:40'   => 'Поле не должно быть не длиннее 40 символов!',
            'unique'   => 'Имя должно быть уникальным для каждой группы',
        ],
        'students' => [
          'min:1' => 'Необходимо выбрать хотя бы одного студента!'
        ],
        'student' => [
            'required'  => 'Поле должно быть заполнено!',
            'max:40'    => 'Поле не должно быть не длиннее 40 символов!'
        ...
        'value' => [
            'required'  => 'Поле должно быть заполнено!',
            'max:5'     => 'Оценка не может быть больше 5 (пяти) баллов!',
            'min:1'     => 'Оценка не может быть меньше 1 (одного) бала!',
    ...
    */
    ...
    'attributes' => [
        ...
        'surname'               => 'фамилия',
        'value'                 => 'академическая оценка по предмету'
    ],
];
